...
--  );
    port (
        ...
        --clk_61MHz     : out std_logic
    );
end entity;

architecture Behavioral of dac_phy_new is
...
begin
    ...
    --clk_to_fpga_o <= clk_to_fpga;
    clk_dac_o   <= clk_dac;

--    -- DAC Clock Wizard
--    mmcm_adac_inst : entity work.mmcm_adac
--    port map (
--        clk_in1   => clk_to_fpga, -- default 61.44 MHz clock from the CDCE
...
--    );
    ...
    -- DAC Clock Wizard
    i_clkwiz_dac : entity work.clkwiz_dac
    port map (
        clk_in1   => clk_to_fpga, -- ext clock from the CDCE, divided by 4 (17.1314 MHz)
        clk_out1  => clk_dac,
        clk_out2  => clk_dac2x,
        reset     => cpu_reset,
        locked    => mmcm_adac_locked
